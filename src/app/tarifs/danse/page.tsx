...
export default function Page() {
    ...
    return (
        <IdsGroupPage
            title="Danse"
            subtitle={<>
                La seconde danse pour <span className="text-accent">150€</span> de <PlusCircle className="inline-block size-5 lg:size-7 text-accent"/> au lieu de 250€. Pour s'inscrire à une seconde danse, veuillez nous contacter directement.
