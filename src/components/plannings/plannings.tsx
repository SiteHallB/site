...
export default function Plannings() {
    ...
    return (
        <PageStructure title="Plannings" subtitle={<p>Consultez nos nombreuses activités</p>}>
            ...
            <ActivityDescription title="Zumba" illustration="/images/plannings/dance.svg" path="/tarifs/boost" description="Dansez, transpirez et amusez-vous ! Un mix explosif de rythmes latinos et de cardio qui fait brûler des calories sans s’en rendre compte."/>
